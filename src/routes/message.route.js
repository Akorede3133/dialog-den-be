...
import { deleteConversation, deleteMessage, getMessages, getRecentChats, sendImage, sendMessage, sendVoiceMessage } from '../controller/message.controller.js';
...
route.delete('/delete/:messageId', isAuth, deleteMessage);
